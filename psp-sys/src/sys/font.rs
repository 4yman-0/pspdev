...
pub struct SceFontNewLibParams {
    ...
    pub alloc_func: Option<
        extern "C" fn(unk_ptr: *mut c_void, amount: usize) -> *mut c_void,
    >,
    pub free_func:
        Option<extern "C" fn(unk_ptr: *mut c_void, ptr: *mut c_void)>,
    ...
    pub close_func: Option<
        extern "C" fn(unk_ptr: *mut c_void, fd: SceUid) -> SceFontErrorCode,
    >,
