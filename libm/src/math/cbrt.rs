...
pub fn cbrt_round(x: f64, round: Round) -> FpResult<f64> {
    ...
    if ady0 < hf64!("0x1p-75") || ady1 < hf64!("0x1p-75") {
        ...
        if ady0 < hf64!("0x1p-98") || ady1 < hf64!("0x1p-98") {
            ...
            if round != Round::Nearest {
                let wlist = [
                    (
                        hf64!("0x1.3a9ccd7f022dbp+0"),
                        hf64!("0x1.1236160ba9b93p+0"),
                    ), // ~ 0x1.1236160ba9b930000000000001e7e8fap+0
                    (
                        hf64!("0x1.7845d2faac6fep+0"),
                        hf64!("0x1.23115e657e49cp+0"),
                    ), // ~ 0x1.23115e657e49c0000000000001d7a799p+0
                    (
                        hf64!("0x1.d1ef81cbbbe71p+0"),
                        hf64!("0x1.388fb44cdcf5ap+0"),
                    ), // ~ 0x1.388fb44cdcf5a0000000000002202c55p+0
                    (
                        hf64!("0x1.0a2014f62987cp+1"),
                        hf64!("0x1.46bcbf47dc1e8p+0"),
                    ), // ~ 0x1.46bcbf47dc1e8000000000000303aa2dp+0
                    (
                        hf64!("0x1.fe18a044a5501p+1"),
                        hf64!("0x1.95decfec9c904p+0"),
                    ), // ~ 0x1.95decfec9c9040000000000000159e8ep+0
                    (
                        hf64!("0x1.a6bb8c803147bp+2"),
                        hf64!("0x1.e05335a6401dep+0"),
                    ), // ~ 0x1.e05335a6401de00000000000027ca017p+0
                    (
                        hf64!("0x1.ac8538a031cbdp+2"),
                        hf64!("0x1.e281d87098de8p+0"),
    ...
    if (m0 ^ m1) <= (1u64 << 30) {
        ...
        if ((f64::from_bits(cvt4) - y1) - dy).abs() < hf64!("0x1p-60")
            || (zz).abs() == 1.0
        {
