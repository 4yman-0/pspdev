...
use crate::support::{
    CastFrom, CastInto, DInt, Float, FpResult, HInt, Int, IntTy, MinInt, Round,
    Status,
};
...
impl<F: Float> Norm<F> {
    ...
    fn from_float(x: F) -> Self {
        ...
        if e == 0 {
            ...
            let scale_f =
                F::from_parts(false, scale_i + F::EXP_BIAS, F::Int::ZERO);
